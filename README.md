...
Four dependency-free suites, 669 checks in total. From the project root:
...
node tests/spelling.test.js     # 165 - typo correction, and what must NOT be corrected
...
│   ├── spelling.test.js     # Spelling corrector suite (165 checks) — mostly non-corrections
