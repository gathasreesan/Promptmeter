 ...
 *
 * Estimates the environmental footprint (electricity and carbon) associated with LLM
 * inference based on token usage.
 *
 * Constants are based on published research (Luccioni et al., 2023).
 */
const PromptMeterCalculator = {
     ...
     * @returns {Object} Footprint metrics { electricity, carbon }.
     */
    calculate: function (totalTokens) {
        if (!totalTokens || totalTokens < 0) {
            return { electricity: 0, carbon: 0 };
        }
     ...
     * @returns {Object} Avoided footprint { electricity, carbon }.
     */
